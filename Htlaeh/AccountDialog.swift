...
class AccountDialog: Dialog {
   ...
   */
   ...
   func addTopHalf() {
      ...
      let image: Icon = Icon(frame: imageFrame, image: Images.Action().account, color: .white)
   ...
   func addMessages() {
      ...
      let firstIcon: Icon = Icon(frame: firstImageFrame, image: Images.Hardware().devices, color: .black)
      ...
      let secondIcon: Icon = Icon(frame: secondImageFrame, image: Images.Editor().free, color: .black)
      ...
      let thirdIcon: Icon = Icon(frame: thirdImageFrame, image: Images.File().cloud, color: .black)
