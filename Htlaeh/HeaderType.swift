...
struct HeaderType : Head {
   ...
   static func home(controller: Home) -> HeaderType {
   ...
   static func search(controller: Search) -> HeaderType {
   ...
   static func all(controller: All) -> HeaderType {
   ...
   static func preview(controller: PreviewWorkout) -> HeaderType {
   ...
   static func new(controller: NewWorkout) -> HeaderType {
   ...
   static func settings(controller: Settings) -> HeaderType {
