...
struct WeightSet: WorkoutSet {
   ...
   static func createStandardSet(name: String, setCount: Int, reps: Int, restTime: Double, weight: Double, date: String, synced: Bool) -> WeightSet {
   ...
   static func createWorkoutForReps(name: String, setCount: Int, restTime: Double?, weight: Double, time: Double, date: String, synced: Bool) -> WeightSet {
   ...
   static func createWorkoutForTime(name: String, setCount: Int, reps: Int, restTime: Double?, weight: Double, date: String, synced: Bool) -> WeightSet {
